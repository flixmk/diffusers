...
class UNet2DPerceiverConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    r"""
    ...
    def forward(
        ...
        # print("Downblock_res_sample_len Beginning: ", len(down_block_res_samples))
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                # print("Equal: ", torch.equal(sample, res_samples[-1]))
            else:
            ...
            # print("Downblock_res_sample_len: ", len(down_block_res_samples))
            # print("Equal: ", torch.equal(sample, res_samples[-1]))
        ...
        # 4.5 Perceiver
        aggregate_res_samples = []
        tmp = down_block_res_samples
        for i, upsample_block in enumerate(self.up_blocks):
